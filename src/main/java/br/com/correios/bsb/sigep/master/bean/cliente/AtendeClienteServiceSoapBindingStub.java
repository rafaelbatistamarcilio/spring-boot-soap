...
public class AtendeClienteServiceSoapBindingStub extends org.apache.axis.client.Stub implements br.com.correios.bsb.sigep.master.bean.cliente.AtendeCliente {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {usuario, senha});
  ...
  throw axisFaultException;
    ...
    public java.lang.String consultaSRO_NEW(java.lang.String[] listaObjetos, java.lang.String tipoResultado, java.lang.String usuarioSro, java.lang.String senhaSro) throws java.rmi.RemoteException, br.com.correios.bsb.sigep.master.bean.cliente.SigepClienteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://cliente.bean.master.sigep.bsb.correios.com.br/", "consultaSRO_NEW"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {listaObjetos, tipoResultado, usuarioSro, senhaSro});
